...
const SERVICE_IMAGES: Record<string, string> = {
  'Painting': '/assets/3484d.png',
  'Plumbing': '/assets/af52d.png',
  'Electrical': '/assets/63616.png',
  'Carpentry': '/assets/a4ca9.png',
  'False Ceiling': '/assets/b9930.png',
  'Modular Kitchen': '/assets/18352.png',
}
const FALLBACK_IMAGE = '/assets/9986c.png'
    ...
    <View style={s.root}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.content}>
        ...
        <Pressable style={s.banner} onPress={() => router.push('StartProject')}>
          <Image source={{ uri: '/assets/0a1c1.png' }} style={s.bannerImg} alt="Full home project" />
            ...
            <View style={s.grid}>
              {services.map((svc) => {
                ...
                return (
                  ...
                  >
                    <Image source={{ uri: image }} style={s.tileImg} alt={svc.name} />
