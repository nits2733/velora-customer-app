...
import ImgTiling from '../../assets/images/049f7.png'
import ImgFalseCeiling from '../../assets/images/b9930.png'
import ImgPlasterWork from '../../assets/images/9986c.png'
...
import ImgHero from '../../assets/images/419c8.png'
import ImgFullHomeChoice from '../../assets/images/74adb.png'
import ImgIndividualServiceChoice from '../../assets/images/0b7a9.png'
...
const SERVICES = [
  { id: 'complete-interior', title: 'Complete Interior', image: ImgCompleteInterior },
  { id: 'electrical', title: 'Electrical', image: ImgElectrical },
  { id: 'plumbing', title: 'Plumbing', image: ImgPlumbing },
  { id: 'carpentry', title: 'Carpentry', image: ImgCarpentry },
  { id: 'painting', title: 'Painting', image: ImgPainting },
  { id: 'tiling', title: 'Tiling', image: ImgTiling },
  { id: 'false-ceiling', title: 'False Ceiling', image: ImgFalseCeiling },
  { id: 'plaster-work', title: 'Plaster Work', image: ImgPlasterWork },
]

const INSPIRATIONS = [
  { id: '1', title: 'Modern Warm Home', image: ImgModernWarmHome },
  { id: '2', title: 'Travertine Details', image: ImgTravertineDetails },
  { id: '3', title: 'Sanctuary Bath', image: ImgSanctuaryBath },
  { id: '4', title: 'Contemporary Living', image: ImgContemporaryLiving },
  { id: '5', title: 'Minimalist Kitchen', image: ImgMinimalistKitchen },
  { id: '6', title: 'Warm Bedroom', image: ImgWarmBedroom },
]
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.page}>
        ...
        <View style={s.section}>
          ...
          <Pressable style={s.choiceCard} onPress={() => router.push('StartProject')}>
            <Image source={ImgFullHomeChoice} style={s.choiceImg} />
          ...
          <Pressable style={[s.choiceCard, { marginTop: 12 }]} onPress={() => router.replace('Services')}>
            <Image source={ImgIndividualServiceChoice} style={s.choiceImg} />
            <View style={s.choiceGrad} />
            <View style={s.choiceContent}>
        ...
        <View style={[s.section, { paddingHorizontal: 0 }]}>
          ...
          >
            {SERVICES.map((svc) => (
              ...
              >
                <Image source={svc.image} style={s.svcImg} />
        ...
        <View style={[s.section, { paddingHorizontal: 0 }]}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={s.carousel}>
            {INSPIRATIONS.map((insp) => (
              ...
              >
                <Image source={insp.image} style={s.inspImg} />
